...
function Set-AllProfileFolders {
    [CmdletBinding()]
    param (
        [Parameter()]
        [String]
    ...
    Set-HKURegistryEntries -RelativeKey $shellFolderKey -Name "My Video" -SID $sid -Value "$userProfileDirectory\Videos" -PropertyType DWORD -ErrorAction SilentlyContinue
