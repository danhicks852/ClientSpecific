...
Write-Log -Text 'This is an example LOG file.' -Type LOG
Write-Log -Text 'This is an example Data file.' -Type DATA
Write-Log -Text 'This is an example Error file.' -Type ERROR